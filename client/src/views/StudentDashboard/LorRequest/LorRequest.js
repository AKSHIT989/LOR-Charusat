    ...
    return (
        ...
        <div className="w-full px-4">
            ...
            <div className="rounded-t bg-white mb-0 px-6 py-6 text-center flex justify-between">
                ...
                <SecondaryButtonOutline text = "Cancel" onClick={()=>history.push('/student')}/>
            </div>
            ...
            <form onSubmit={(e)=>e.preventDefault()}>
                ...
                <div className="w-full lg:w-12/12 px-4">
                    ...
                    <RadioButton name="cdpc" text="No"/>
                    <RadioButton name="cdpc" text="Yes"/>
                    </div>
                </div>
                <div className="w-full lg:w-12/12 px-4">
                    <div className="relative w-full mb-3">
                    ...
                    <RadioButton name="bond" text="No"/>
                    <RadioButton name="bond" text="Yes"/>
                    </div>
                </div>
                </div>
                <hr className="mt-6 border-b-1 border-gray-400" />
